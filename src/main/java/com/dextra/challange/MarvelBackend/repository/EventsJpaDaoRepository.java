...
@Repository
public class EventsJpaDaoRepository extends JdbcDaoSupport {
	
	private static Logger logger = LoggerFactory.getLogger(EventsJpaDaoRepository.class);
	...
	public List<Event> getEvents(Integer characterId) {
		
		Character result = null;
		
		try {		
			
			result = em.createNamedQuery("Comic.Find_Events", Character.class)
